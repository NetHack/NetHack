/* NetHack 3.6	trap.c	$NHDT-Date: 1428207616 2015/04/05 04:20:16 $  $NHDT-Branch: nhmall-booktribute $:$NHDT-Revision: 1.224 $ */
/* NetHack 3.6	trap.c	$Date: 2013/03/14 01:58:21 $  $Revision: 1.179 $ */
