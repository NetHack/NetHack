/* NetHack 3.6	wizard.c	$NHDT-Date: 1431192761 2015/05/09 17:32:41 $  $NHDT-Branch: master $:$NHDT-Revision: 1.35 $ */
/* NetHack 3.6	wizard.c	$Date: 2009/05/06 10:48:16 $  $Revision: 1.32 $ */
