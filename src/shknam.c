/* NetHack 3.6	shknam.c	$NHDT-Date: 1428207608 2015/04/05 04:20:08 $  $NHDT-Branch: nhmall-booktribute $:$NHDT-Revision: 1.32 $ */
/* NetHack 3.6	shknam.c	$Date: 2011/04/15 01:55:42 $  $Revision: 1.24 $ */
