...
STATIC_DCL int monmulti(struct monst *, struct obj *, struct obj *);
STATIC_DCL void monshoot(struct monst *, struct obj *, struct obj *);
STATIC_DCL int drop_throw(struct obj *, boolean, int, int);
STATIC_DCL boolean m_lined_up(struct monst *, struct monst *);
...
int
thitu(int tlev, int dam, struct obj **objp,
