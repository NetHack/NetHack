...
STATIC_DCL boolean evaluate_and_notify_windowport_field
                         (int, boolean *, int, int);
STATIC_DCL void evaluate_and_notify_windowport(boolean *, int, int);
...
STATIC_DCL void merge_bestcolor(int *, int);
STATIC_DCL void get_hilite_color(int, int, genericptr_t, int,
                                                int, int *);
...
STATIC_OVL boolean
hilite_reset_needed(struct istat_s *bl_p, long augmented_time)
{
...
STATIC_OVL void
merge_bestcolor(int *bestcolor, int newcolor)
{
...
STATIC_OVL void
get_hilite_color(int idx, int fldidx, genericptr_t vp, int chg, int pc, int *colorptr)
{
