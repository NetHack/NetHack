/* NetHack 3.6	dlb.c	$NHDT-Date: 1431192761 2015/05/09 17:32:41 $  $NHDT-Branch: master $:$NHDT-Revision: 1.13 $ */
/* NetHack 3.6	dlb.c	$Date: 2012/02/16 03:01:37 $  $Revision: 1.10 $ */
