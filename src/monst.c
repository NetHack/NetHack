 ...
 */
#define MON(nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, rac, col) \
    {                                                                      \
        nam, sym, lvl, gen, atk, siz, mr1, mr2, flg1, flg2, flg3, rac, C(col)   \
    }
...
NEARDATA struct permonst mons[] = {
    ...
    MON("chickatrice", S_COCKATRICE, LVL(4, 4, 8, 30, 0),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE, 0, CLR_BROWN),
    ...
    MON("werejackal", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_HOSTILE, M3_INFRAVISIBLE, MH_WERE, CLR_BROWN),
    ...
    MON("beholder", S_EYE,
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
        M2_NOPOLY | M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 0, CLR_BROWN),
#endif
    /*
     * felines
     */
    ...
    MON("winged gargoyle", S_GREMLIN, LVL(9, 15, -2, 0, -12), (G_GENO | 1),
        ...
        M2_LORD | M2_HOSTILE | M2_STRONG | M2_MAGIC, 0, 0, HI_LORD),
    /*
     * humanoids
     */
    MON("hobbit", S_HUMANOID, LVL(1, 9, 10, 0, 6), (G_GENO | 2),
        ...
        M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION, 0, CLR_GREEN),
    MON("dwarf", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DWARF, CLR_RED),
    MON("bugbear", S_HUMANOID, LVL(3, 9, 5, 0, -6), (G_GENO | 1),
        ...
        M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION, 0, CLR_BROWN),
    MON("dwarf lord", S_HUMANOID, LVL(4, 6, 10, 10, 5), (G_GENO | 2),
        ...
        M2_STRONG | M2_LORD | M2_MALE | M2_GREEDY | M2_JEWELS
            | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DWARF, CLR_BLUE),
    MON("dwarf king", S_HUMANOID, LVL(6, 6, 10, 20, 6), (G_GENO | 1),
        ...
        M2_STRONG | M2_PRINCE | M2_MALE | M2_GREEDY | M2_JEWELS
            | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DWARF, HI_LORD),
    ...
    MON("manes", S_IMP, LVL(1, 3, 7, 0, -7),
        ...
        M2_HOSTILE | M2_STALK, M3_INFRAVISIBLE | M3_INFRAVISION, 0, CLR_RED),
    ...
    MON("quasit", S_IMP, LVL(3, 15, 2, 20, -7), (G_GENO | 2),
        ...
        M2_STALK, M3_INFRAVISIBLE | M3_INFRAVISION, 0, CLR_BLUE),
    ...
    MON("leprechaun", S_LEPRECHAUN, LVL(5, 15, 8, 20, 0), (G_GENO | 4),
        ...
        M2_HOSTILE | M2_GREEDY, M3_INFRAVISIBLE, 0, CLR_GREEN),
    /*
     * mimics
     */
    ...
    MON("wood nymph", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_FEMALE | M2_COLLECT, M3_INFRAVISIBLE, 0, CLR_GREEN),
    ...
    MON("mountain nymph", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_SEDUCE, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_TPORT,
        M2_HOSTILE | M2_FEMALE | M2_COLLECT, M3_INFRAVISIBLE, 0, CLR_BROWN),
    /*
     * orcs
     */
    MON("goblin", S_ORC, LVL(0, 6, 10, 0, -3), (G_GENO | 2),
        ...
        M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION, MH_ORC,
        CLR_GRAY),
    ...
    MON("pony", S_UNICORN, LVL(3, 16, 6, 0, 0), (G_GENO | 2),
        ...
        M2_WANDER | M2_STRONG | M2_DOMESTIC, M3_INFRAVISIBLE, 0, CLR_BROWN),
    ...
    MON("Angel", S_ANGEL, LVL(14, 10, -4, 55, 12),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, CLR_WHITE),
    ...
    MON("gnome lord", S_GNOME, LVL(3, 8, 10, 4, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GNOME, CLR_BLUE),
    MON("gnomish wizard", S_GNOME, LVL(3, 10, 4, 10, 0), (G_GENO | 1),
        A(ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(700, 120, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION, MH_GNOME,
        HI_ZAP),
    MON("gnome king", S_GNOME, LVL(5, 10, 10, 20, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GNOME, HI_LORD),
#ifdef SPLITMON_1
};
#endif
#endif /* !SPLITMON_2 */
...
struct permonst _mons2[] = {
    ...
    MON("giant", S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_NOGEN | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GIANT, CLR_RED),
    MON("stone giant", S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GIANT, CLR_GRAY),
    MON("hill giant", S_GIANT, LVL(8, 10, 6, 0, -2), (G_GENO | G_SGROUP | 1),
        ...
        M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GIANT, CLR_CYAN),
    MON("fire giant", S_GIANT, LVL(9, 12, 4, 5, 2), (G_GENO | G_SGROUP | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GIANT, CLR_YELLOW),
    MON("frost giant", S_GIANT, LVL(10, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GIANT, CLR_WHITE),
    ...
    MON("storm giant", S_GIANT, LVL(16, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GIANT, CLR_BLUE),
    ...
    MON("Keystone Kop", S_KOP, LVL(1, 6, 10, 10, 9),
        ...
        M3_INFRAVISIBLE, MH_HUMAN, CLR_BLUE),
    ...
    MON("Kop Lieutenant", S_KOP, LVL(3, 10, 10, 20, 11), (G_GENO | G_NOGEN),
        ...
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, CLR_CYAN),
    MON("Kop Kaptain", S_KOP, LVL(4, 12, 10, 20, 12), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, HI_LORD),
    /*
     * Liches
     */
    MON("lich", S_LICH, LVL(11, 6, 0, 30, -9), (G_GENO | G_NOCORPSE | 1),
        ...
        M2_HOSTILE | M2_MAGIC, M3_INFRAVISION, MH_UNDEAD, CLR_BROWN),
    MON("demilich", S_LICH, LVL(14, 9, -2, 60, -12),
        ...
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON,
        MR_COLD, M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_HOSTILE | M2_MAGIC, M3_INFRAVISION, MH_UNDEAD, CLR_RED),
    ...
    MON("kobold mummy", S_MUMMY, LVL(3, 8, 6, 20, -2),
        ...
        M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD, CLR_BROWN),
    MON("gnome mummy", S_MUMMY, LVL(4, 10, 6, 20, -3),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE, M3_INFRAVISION, MH_GNOME | MH_UNDEAD, CLR_RED),
    MON("orc mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        ...
        M3_INFRAVISION, MH_ORC | MH_UNDEAD, CLR_GRAY),
    MON("dwarf mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE | M2_GREEDY | M2_JEWELS,
        M3_INFRAVISION, MH_DWARF | MH_UNDEAD, CLR_RED),
    MON("elf mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        ...
        M2_HOSTILE, M3_INFRAVISION, MH_ELF | MH_UNDEAD, CLR_GREEN),
    MON("human mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE, M3_INFRAVISION, MH_HUMAN | MH_UNDEAD, CLR_GRAY),
    MON("ettin mummy", S_MUMMY, LVL(7, 12, 4, 30, -6),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISION, MH_UNDEAD, CLR_BLUE),
    MON("giant mummy", S_MUMMY, LVL(8, 14, 3, 30, -7),
        ...
        M3_INFRAVISION, MH_UNDEAD | MH_GIANT, CLR_CYAN),
    /*
     * Nagas
     */
    ...
    MON("disenchanter", S_RUSTMONST, LVL(12, 12, -10, 0, -3),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE, 0, CLR_BLUE),
    /*
     * Snakes
     */
    ...
    MON("umber hulk", S_UMBER, LVL(9, 6, 2, 25, 0), (G_GENO | 2),
        ...
        M2_STRONG, M3_INFRAVISIBLE, 0, CLR_BROWN),
    /*
     * Vampires
     */
    MON("vampire", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
        ...
        M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE, MH_UNDEAD, CLR_RED),
    MON("vampire lord", S_VAMPIRE, LVL(12, 14, 0, 50, -9),
        ...
        M3_INFRAVISIBLE, MH_UNDEAD, CLR_BLUE),
#if 0 /* DEFERRED */
    MON("vampire mage", S_VAMPIRE,
        ...
        M3_INFRAVISIBLE, MH_UNDEAD, HI_ZAP),
#endif
    MON("Vlad the Impaler", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
        ...
        M3_WAITFORU | M3_WANTSCAND | M3_INFRAVISIBLE, MH_UNDEAD, HI_LORD),
    /*
     * Wraiths
     */
    MON("barrow wight", S_WRAITH, LVL(3, 12, 5, 5, -3),
        ...
        M2_STALK | M2_HOSTILE | M2_COLLECT, 0, MH_UNDEAD, CLR_GRAY),
    MON("wraith", S_WRAITH, LVL(6, 12, 4, 15, -6), (G_GENO | 2),
        ...
        M2_STALK | M2_HOSTILE, 0, MH_UNDEAD, CLR_BLACK),
    ...
    MON("monkey", S_YETI, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_HUMANOID | M1_OMNIVORE, 0, M3_INFRAVISIBLE, 0, CLR_GRAY),
    ...
    MON("kobold zombie", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        ...
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD, CLR_BROWN),
    ...
    MON("orc zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        SIZ(850, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION, MH_ORC | MH_UNDEAD,
        CLR_GRAY),
    ...
    MON("human zombie", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        ...
        M2_STALK | M2_HOSTILE, M3_INFRAVISION, MH_HUMAN | MH_UNDEAD,
        HI_DOMESTIC),
    MON("ettin zombie", S_ZOMBIE, LVL(6, 8, 6, 0, -4),
        ...
        SIZ(1700, 250, MS_SILENT, MZ_HUGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_STALK | M2_HOSTILE | M2_STRONG, M3_INFRAVISION, MH_UNDEAD,
        CLR_BLUE),
    MON("ghoul", S_ZOMBIE, LVL(3, 6, 10, 0, -2), (G_GENO | G_NOCORPSE | 1),
        ...
        M2_WANDER | M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD, CLR_BLACK),
    ...
    MON("skeleton", S_ZOMBIE, LVL(12, 8, 4, 0, 0), (G_NOCORPSE | G_NOGEN),
        ...
        M3_INFRAVISION, MH_UNDEAD, CLR_WHITE),
    /*
     * golems
     */
    ...
    MON("wererat", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        ...
        M3_INFRAVISIBLE, MH_HUMAN | MH_WERE, CLR_BROWN),
    MON("werejackal", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        ...
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN | MH_WERE, CLR_RED),
    MON("werewolf", S_HUMAN, LVL(5, 12, 10, 20, -7), (1),
        ...
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN | MH_WERE, CLR_ORANGE),
    MON("elf", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_ELF, HI_DOMESTIC),
    MON("Woodland-elf", S_HUMAN, LVL(4, 12, 10, 10, -5),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_ELF, CLR_GREEN),
    MON("Green-elf", S_HUMAN, LVL(5, 12, 10, 10, -6), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_ELF, CLR_BRIGHT_GREEN),
    MON("Grey-elf", S_HUMAN, LVL(6, 12, 10, 10, -7), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_ELF, CLR_GRAY),
    MON("elf-lord", S_HUMAN, LVL(8, 12, 10, 20, -9), (G_GENO | G_SGROUP | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_ELF, CLR_BRIGHT_BLUE),
    MON("Elvenking", S_HUMAN, LVL(9, 12, 10, 25, -10), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_ELF, HI_LORD),
    MON("doppelganger", S_HUMAN, LVL(9, 12, 5, 20, 0), (G_GENO | 1),
        ...
        M2_NOPOLY | M2_HOSTILE | M2_STRONG | M2_COLLECT
            | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE, MH_HUMAN, HI_DOMESTIC),
    ...
    MON("prisoner", S_HUMAN, LVL(12, 12, 10, 0, 0),
        ...
        M3_INFRAVISIBLE | M3_CLOSE, MH_HUMAN, HI_DOMESTIC),
    ...
    MON("aligned priest", S_HUMAN, LVL(12, 12, 10, 50, 0), G_NOGEN,
        ...
        M3_INFRAVISIBLE, MH_HUMAN, CLR_WHITE),
    ...
    MON("soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        ...
        M3_INFRAVISIBLE, MH_HUMAN, CLR_GRAY),
    MON("sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
                                       | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, CLR_RED),
    ...
    MON("lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
                                       | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, CLR_GREEN),
    ...
    MON("Wizard of Yendor", S_HUMAN, LVL(30, 12, -8, 100, A_NONE),
        ...
        M2_NOPOLY | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_PRINCE
            | M2_MALE | M2_MAGIC,
        M3_COVETOUS | M3_WAITFORU | M3_INFRAVISIBLE, MH_HUMAN, HI_LORD),
    ...
    MON("shade", S_GHOST, LVL(12, 10, 10, 0, 0), (G_NOCORPSE | G_NOGEN),
        ...
        M3_INFRAVISION, MH_UNDEAD, CLR_BLACK),
    /*
     * (major) demons
     */
    MON("water demon", S_DEMON, LVL(8, 12, -4, 30, -7),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, CLR_BLUE),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("succubus", S_DEMON, LVL(6, 12, 0, 70, -9), (G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, CLR_GRAY),
    MON("horned devil", S_DEMON, LVL(6, 9, -5, 50, 11),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, CLR_BROWN),
    ...
    MON("erinys", S_DEMON, LVL(7, 12, 2, 30, 10),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, CLR_RED),
    ...
    MON("ice devil", S_DEMON, LVL(11, 6, -4, 55, -12),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, CLR_WHITE),
    ...
    MON("Yeenoghu", S_DEMON, LVL(56, 18, -5, 80, -15),
        ...
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_LORD | M2_MALE | M2_COLLECT,
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, HI_LORD),
    ...
    MON("Death", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_DISPLACES, 0, HI_LORD),
    ...
    MON("chameleon", S_LIZARD, LVL(6, 5, 6, 10, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_SHAPESHIFTER, 0, 0, CLR_BROWN),
    ...
    MON("long worm tail", S_WORM_TAIL, LVL(0, 0, 0, 0, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, 0, 0), 0, 0, 0L, M2_NOPOLY, 0, 0, CLR_BROWN),
    /* Note:
    ...
    MON("Lord Carnarvon", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, HI_LORD),
    ...
    MON("Earendil", S_HUMAN,
        ...
        M3_CLOSE | M3_INFRAVISION | M3_INFRAVISIBLE, MH_ELF, HI_LORD),
    MON("Elwing", S_HUMAN,
        LVL(20, 12, 0, 50, -20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Grand Master", S_HUMAN, LVL(25, 12, 0, 70, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_MALE | M2_NASTY
            | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, CLR_BLACK),
    MON("Arch Priest", S_HUMAN, LVL(25, 12, 7, 70, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_MALE | M2_COLLECT
            | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, CLR_WHITE),
    MON("Orion", S_HUMAN, LVL(20, 12, 0, 30, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISION | M3_INFRAVISIBLE, MH_HUMAN, HI_LORD),
    ...
    MON("Twoflower", S_HUMAN, LVL(20, 12, 10, 20, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, HI_DOMESTIC),
    ...
    MON("Neferet the Green", S_HUMAN, LVL(20, 12, 0, 60, 0),
        ...
        M2_NOPOLY | M2_FEMALE | M2_PNAME | M2_PEACEFUL | M2_STRONG
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, CLR_GREEN),
    /*
     * quest nemeses
     */
    ...
    MON("Thoth Amon", S_HUMAN, LVL(16, 12, 0, 10, -14),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE, MH_HUMAN, HI_LORD),
    ...
    MON("Scorpius", S_SPIDER, LVL(15, 12, 10, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU, 0, HI_LORD),
    ...
    MON("Dark One", S_HUMAN, LVL(15, 12, 0, 80, -10),
        ...
        M2_NOPOLY | M2_STRONG | M2_HOSTILE | M2_STALK | M2_NASTY
            | M2_COLLECT | M2_MAGIC,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE, MH_HUMAN, CLR_BLACK),
    /*
     * quest "guardians"
     */
    ...
    MON("hunter", S_HUMAN, LVL(5, 12, 10, 10, -7), G_NOGEN,
        ...
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_HUMAN, HI_DOMESTIC),
