/* NetHack 3.6	display.c	$NHDT-Date: 1430365890 2015/04/30 03:51:30 $  $NHDT-Branch: master $:$NHDT-Revision: 1.49 $ */
/* NetHack 3.6	display.c	$Date: 2011/12/05 03:17:36 $  $Revision: 1.34 $ */
