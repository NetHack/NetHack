/* NetHack 3.6	exper.c	$NHDT-Date: 1431192764 2015/05/09 17:32:44 $  $NHDT-Branch: master $:$NHDT-Revision: 1.24 $ */
/* NetHack 3.6	exper.c	$Date: 2009/05/06 10:46:24 $  $Revision: 1.19 $ */
