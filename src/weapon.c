/* NetHack 3.6	weapon.c	$NHDT-Date: 1431192757 2015/05/09 17:32:37 $  $NHDT-Branch: master $:$NHDT-Revision: 1.49 $ */
/* NetHack 3.6	weapon.c	$Date: 2011/12/18 05:16:28 $  $Revision: 1.38 $ */
