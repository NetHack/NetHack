/* NetHack 3.6	dog.c	$NHDT-Date: 1431192761 2015/05/09 17:32:41 $  $NHDT-Branch: master $:$NHDT-Revision: 1.48 $ */
/* NetHack 3.6	dog.c	$Date: 2011/04/15 01:55:42 $  $Revision: 1.37 $ */
