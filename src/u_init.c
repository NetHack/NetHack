/* NetHack 3.6	u_init.c	$NHDT-Date: 1431192761 2015/05/09 17:32:41 $  $NHDT-Branch: master $:$NHDT-Revision: 1.33 $ */
/* NetHack 3.6	u_init.c	$Date: 2011/10/01 00:25:56 $  $Revision: 1.18 $ */
