/* NetHack 3.6	lock.c	$NHDT-Date: 1431192768 2015/05/09 17:32:48 $  $NHDT-Branch: master $:$NHDT-Revision: 1.59 $ */
/* NetHack 3.6	lock.c	$Date: 2014/09/20 00:32:01 $  $Revision: 1.39 $ */
