...
STATIC_DCL int FDECL(kick_object, (xchar, xchar, char *));
...
STATIC_OVL void
kickdmg(register struct monst *mon, register boolean clumsy)
{
...
STATIC_OVL void
otransit_msg(register struct obj *otmp, register boolean nodrop, long num)
{
    char obuf[BUFSZ];
