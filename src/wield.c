/* NetHack 3.6	wield.c	$NHDT-Date: 1427062304 2015/03/22 22:11:44 $  $NHDT-Branch: master $:$NHDT-Revision: 1.34 $ */
/* NetHack 3.6	wield.c	$Date: 2009/05/06 10:48:14 $  $Revision: 1.31 $ */
