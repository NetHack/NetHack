/* NetHack 3.6	rumors.c	$NHDT-Date: 1431192757 2015/05/09 17:32:37 $  $NHDT-Branch: master $:$NHDT-Revision: 1.25 $ */
/* NetHack 3.6	rumors.c	$Date: 2012/05/11 22:36:33 $  $Revision: 1.17 $ */
