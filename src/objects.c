...
NEARDATA struct objdescr const_obj_descr[] =
#else
...
NEARDATA struct objclass const_objects[] =
#endif
{
...
struct objdescr obj_descr[SIZE(const_obj_descr)];
struct objclass objects[SIZE(const_objects)];
