...
DRGN_ARMR("purple dragon scales",      0, SLEEP_RES,   700, 7, CLR_BRIGHT_MAGENTA),
...
CLOAK("orcish cloak", "coarse mantelet",
      0, 0,          0,  4, 0, 10, 40, 10, 1,  CLOTH, CLR_BLACK),
CLOAK("flowing dress", None,
      0, 0,          0,  4, 0, 10, 50, 10, 1,  CLOTH, CLR_BLUE),
CLOAK("snappy tuxedo", None,
      0, 0,          0,  4, 0, 10, 50, 10, 1,  CLOTH, CLR_BLACK),
CLOAK("dwarvish cloak", "hooded cloak",
      0, 0,          0,  4, 0, 10, 50, 10, 1,  CLOTH, HI_CLOTH),
CLOAK("iron mantle", "metallic cloak",
...
SHIELD("shield of resonance", "polished silver shield",
       0, 1, 0, SONIC_RES, 3, 0,  50, 50, 8, 0,  SILVER, HI_SILVER),
