/* NetHack 3.5	do_wear.c	$NHDT-Date$  $NHDT-Branch$:$NHDT-Revision$ */
/* NetHack 3.5	do_wear.c	$Date: 2012/02/05 04:26:48 $  $Revision: 1.69 $ */
...
take_off(VOID_ARGS)
{
	...
	if (otmp) doff->delay += objects[otmp->otyp].oc_delay;
