/* NetHack 3.6	do.c	$NHDT-Date: 1429666911 2015/04/22 01:41:51 $  $NHDT-Branch: master $:$NHDT-Revision: 1.130 $ */
/* NetHack 3.6	do.c	$Date: 2014/11/18 03:10:39 $  $Revision: 1.101 $ */
