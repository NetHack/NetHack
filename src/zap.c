...
STATIC_DCL void destroy_one_item(struct obj *, int, int);
STATIC_DCL void wishcmdassist(int);
...
boolean
get_mon_location(struct monst *mon,
                 xchar *xp,
                 xchar *yp,
...
bhit(register int ddx, register int ddy,    /* direction */
     ...
     enum bhit_call_types weapon,           /* see values in hack.h */
...
int
zhitm(register struct monst *mon,
      register int type,
      register int nd,
 ...
 */
void
dobuzz(register int type, register int nd, register xchar sx, register xchar sy, register int dx, register int dy, boolean say /* Announce out of sight hit/miss events if true */)
{
...
void
fracture_rock(register struct obj *obj) /* no texts here! */
{
    xchar x, y;
