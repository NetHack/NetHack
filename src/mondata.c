/* NetHack 3.6	mondata.c	$NHDT-Date: 1431192756 2015/05/09 17:32:36 $  $NHDT-Branch: master $:$NHDT-Revision: 1.52 $ */
/* NetHack 3.6	mondata.c	$Date: 2011/10/02 02:18:54 $  $Revision: 1.44 $ */
