/* NetHack 3.6	wc_chainout.c	$NHDT-Date: 1431192771 2015/05/09 17:32:51 $  $NHDT-Branch: master $:$NHDT-Revision: 1.5 $ */
/* NetHack 3.6	wc_chainout.c	$Date: 2012/01/23 10:45:31 $  $Revision: 1.2 $ */
