...
static void draw_status(unsigned long *);
static void draw_classic(boolean, unsigned long *);
static void draw_vertical(boolean, unsigned long *);
static void draw_horizontal(boolean, unsigned long *);
