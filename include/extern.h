/* NetHack 3.6	extern.h	$NHDT-Date: 1672682728 2023/01/02 18:05:28 $  $NHDT-Branch: releasebits-3.6 $:$NHDT-Revision: 1.748 $ */
...
E unsigned FDECL(Strlen_, (const char *, const char *, int));
