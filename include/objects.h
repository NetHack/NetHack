...
DRGN_ARMR("gray dragon scale mail",    1, ANTIMAGIC,  1200, 1, PALLID,
...
DRGN_ARMR("gray dragon scales",        0, ANTIMAGIC,   700, 7, PALLID,
                                                        GRAY_DRAGON_SCALES),
...
FOOD("glob of gray ooze",     0,  2, 20, 0, FLESH,  20, PALLID,
                                                        GLOB_OF_GRAY_OOZE),
...
POTION("object detection",      "smoky",  1, 0, 42, 150, PALLID,
                                                        POT_OBJECT_DETECTION),
POTION("gain energy",          "cloudy",  1, 0, 42, 150, CLR_WHITE,
                                                        POT_GAIN_ENERGY),
POTION("sleeping",       "effervescent",  1, 0, 42, 100, PALLID,
                                                        POT_SLEEPING),
...
/* fixed description
 */
POTION("water",                 "clear",  0, 0, 92, 100, NO_COLOR,
                                                        POT_WATER),
#undef POTION
...
SPELL("detect treasure", "gray",
      P_DIVINATION_SPELL,  20,  5, 4, 1, NODIR, PALLID,
                                                        SPE_DETECT_TREASURE),
 ...
 * (inclusive).
 */
ROCK("luckstone", "gray",  0,  10,  10, 60, 3, 3, 1, 10, 7, MINERAL, PALLID,
                                                                    LUCKSTONE),
ROCK("loadstone", "gray",  0,  10, 500,  1, 3, 3, 1, 10, 6, MINERAL, PALLID,
                                                                    LOADSTONE),
ROCK("touchstone", "gray", 0,   8,  10, 45, 3, 3, 1, 10, 6, MINERAL, PALLID,
                                                                  TOUCHSTONE),
ROCK("flint", "gray",      0,  10,  10,  1, 6, 6, 0, 10, 7, MINERAL, PALLID,
                                                                    FLINT),
