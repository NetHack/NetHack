 ...
 */
    ...
    MON("hobbit mummy", S_MUMMY, LVL(4, 10, 6, 20, -3),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M3_INFRAVISION, 5, CLR_RED, HOBBIT_MUMMY),
    ...
    MON("orc zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        CLR_GRAY, ORC_ZOMBIE),
    MON("hobbit zombie", S_ZOMBIE, LVL(1, 6, 10, 0, -2),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_GROAN, MZ_SMALL), 0, 0, MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_POIS,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M3_INFRAVISION, 2, CLR_GREEN, HOBBIT_ZOMBIE),
