 ...
 */
    ...
    MON(NAM("transmuter"), S_RUSTMONST,
        ...
        A(ATTK(AT_CLAW, AD_MTRL, 2, 2), ATTK(AT_NONE, AD_MTRL, 0, 0),
        NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(750, 200, MS_GROWL, MZ_LARGE),  0, 0, M1_ANIMAL | M1_METALLIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE,
        14, CLR_BRIGHT_CYAN, TRANSMUTER),
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("Ixoth"), S_DRAGON,
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE,
        22, CLR_RED, IXOTH),
    MON(NAM("Sostratus"), S_HUMAN,
        LVL(15, 12, -10, 10, -20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_SAMU, 1, 4),
            NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_NOPOLY | M2_HUMAN | M2_MALE | M2_PNAME | M2_HOSTILE | M2_STRONG
            | M2_NASTY | M2_STALK | M2_COLLECT | M2_MAGIC | M2_GREEDY,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE,
        20, HI_LORD, SOSTRATUS),
