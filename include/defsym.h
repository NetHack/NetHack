...
#define PCHAR2(idx, ch, sym, tilenm, desc, clr) PCHAR(idx, ch, sym, desc, clr)
    ...
    /* start cmap A                                                      */
    PCHAR2(12, '.',  S_ndoor,  "no door", "doorway", CLR(NO_COLOR))
    ...
    PCHAR( 47, '#',  S_cloud,  "cloud", CLR(NO_COLOR))
    ...
    PCHAR( 51, '^',  S_falling_rock_trap, "falling rock trap", CLR(NO_COLOR))
    ...
    PCHAR( 66, '"',  S_web, "web", CLR(NO_COLOR))
