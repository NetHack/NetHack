...
#define is_undead(ptr) (((ptr)->mrace & MH_UNDEAD) != 0L)
#define is_were(ptr) (((ptr)->mrace & MH_WERE) != 0L)
#define is_elf(ptr) (((ptr)->mrace & MH_ELF) != 0L)
#define is_dwarf(ptr) (((ptr)->mrace & MH_DWARF) != 0L)
#define is_gnome(ptr) (((ptr)->mrace & MH_GNOME) != 0L)
#define is_orc(ptr) (((ptr)->mrace & MH_ORC) != 0L)
#define is_human(ptr) (((ptr)->mrace & MH_HUMAN) != 0L)
#define your_race(ptr) (((ptr)->mflags2 & urace.selfmask) != 0L)
#define is_bat(ptr)                                         \
    ((ptr) == &mons[PM_BAT] || (ptr) == &mons[PM_GIANT_BAT] \
     || (ptr) == &mons[PM_VAMPIRE_BAT])
#define is_bird(ptr) ((ptr)->mlet == S_BAT && !is_bat(ptr))
#define is_giant(ptr) (((ptr)->mrace & MH_GIANT) != 0L)
#define is_golem(ptr) ((ptr)->mlet == S_GOLEM)
#define is_domestic(ptr) (((ptr)->mflags2 & M2_DOMESTIC) != 0L)
#define is_demon(ptr) (((ptr)->mrace & MH_DEMON) != 0L)
