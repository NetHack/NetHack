...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Demonbane", LONG_SWORD, (SPFX_RESTR | SPFX_DFLAGR), 0, MH_DEMON,
      PHYS(5, 0), NO_DFNS, NO_CARY, 0, A_LAWFUL, NON_PM, NON_PM, 2500L,
      NO_COLOR),

    A("Werebane", SILVER_SABER, (SPFX_RESTR | SPFX_DFLAGR), 0, MH_WERE,
    ...
    A("Giantslayer", LONG_SWORD, (SPFX_RESTR | SPFX_DFLAGR), 0, MH_GIANT,
    ...
    A("Sunsword", LONG_SWORD, (SPFX_RESTR | SPFX_DFLAGR), 0, MH_UNDEAD,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL,
    ...
    A("The Mitre of Holiness", HELM_OF_BRILLIANCE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_DFLAGR | SPFX_INTEL | SPFX_PROTECT), 0,
