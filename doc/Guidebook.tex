...
\begin{verbatim}
        ...
        Doom:1 $:993 HP:9(12) Pw:3(3) AC:10 Exp:1/19 T:752 Hungry Conf
\end{verbatim}
\begin{center}
Figure 1
\end{center}
...
%.lp
\item[\bb{Location}]
Your general position within the Mazes of Menace.  You start out on the
first level of the Dungeons of Doom.  The level number increases as you
you go deeper into the dungeon.  You might encounter other locations.
The Amulet of Yendor is reputedly somewhere beneath the twentieth level.
%.lp
\item[\bb{Gold}]
