...
Since using this command by accident can cause trouble, you will be
prompted to confirm your intent before praying.
%.lp
\item[\tb{\#prevmsg}]
...
prompting is desired.  The default is ``{\it paranoid\verb+_+confirmation:none}''.
%.sd
%.si
\newlength{\pcwidth}
...
\item[{\tt pray~~~}]
require ``{\tt yes}'' rather than `{\tt y}' to confirm an attempt to pray
