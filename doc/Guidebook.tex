...
%.lp
\item[\tb{\#permnearby}]
If persistent nearby characters display is supported and enabled (with the
{\it perm\verb+_+nearby\/} option), toggle whether it is displaying
nearby monsters or items. Default key is {\tt \verb+]+}.
%.lp
\item[\tb{\#pickup}]
