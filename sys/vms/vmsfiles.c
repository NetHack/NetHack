/* NetHack 3.6	vmsfiles.c	$NHDT-Date: 1431192780 2015/05/09 17:33:00 $  $NHDT-Branch: master $:$NHDT-Revision: 1.8 $ */
/* NetHack 3.6	vmsfiles.c	$Date: 2009/05/06 10:51:25 $  $Revision: 1.5 $ */
