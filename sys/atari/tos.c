/* NetHack 3.6	tos.c	$NHDT-Date: 1431192784 2015/05/09 17:33:04 $  $NHDT-Branch: master $:$NHDT-Revision: 1.6 $ */
/* NetHack 3.6	tos.c	$Date: 2009/05/06 10:48:51 $  $Revision: 1.3 $ */
